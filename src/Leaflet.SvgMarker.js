...
(function() {
  ...
  function makeIconSvg(color,svg) {
    ...
    if (!svg) {
      ...
      icon =
        '<svg version="1.1" class="svgMarker-marker" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="222.826px" height="300px" viewBox="0 0 222.826 300" enable-background="new 0 0 222.826 300" xml:space="preserve"> <path class="svgMarker-marker-outer" stroke="black" stroke-width="2" fill="rgba(' +
        color +
        ',0.7)" d="M102.612,1.725C84.106,4.293,74.831,6.91,62.176,13.094c-7.469,3.664-9.609,4.948-17.03,10.418 c-9.609,6.993-16.269,13.653-23.31,23.215C7.47,66.231,0.049,88.542,0.001,112.042c-0.047,11.56,1.855,21.597,6.708,35.917 c6.041,17.885,18.362,43.194,32.158,65.885c4.853,8.039,16.983,26.307,21.264,32.206c18.41,24.975,31.979,36.125,42.73,44.449 c2.331,1.808,6.48,4.668,7.907,4.668c1.379,0,5.983-2.86,8.361-4.668c8.944-6.801,26.819-21.474,38.665-37.837 c1.569-2.188,3.282-4.52,3.853-5.232c1.903-2.428,12.035-17.363,16.698-24.595c19.171-29.875,34.917-62.604,40.958-85.342 c2.616-9.753,3.568-16.46,3.521-25.451c0-34.728-16.936-67.884-45.146-88.53c-7.468-5.47-9.562-6.754-17.03-10.418 c-15.745-7.659-30.303-11.179-47.571-11.417C108.13,1.582,103.421,1.629,102.612,1.725z"/> <path class="svgMarker-marker-inner" fill="rgb(' +
        color +
